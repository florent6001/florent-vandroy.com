...
export default function politique_de_confidentialite_des_donnees() {
    return (
        <Layout 
            pageTitle='Politique de confidentialité des données'
            pageDescription="Politique de confidentialité du site www.florent-vandroy.fr/"
        >
            <div className="mt-5">
                <h1 className="text-primary">Politique de confidentialité</h1>
                <p>Le site web Florent Vandroy est détenu par Florent Vandroy, qui est un contrôleur de données de vos données personnelles.</p>
                <p>Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par Florent Vandroy, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d&apos;utiliser le site web de Florent Vandroy.</p>
                ...
                <p>Lorsque vous visitez le Florent Vandroy, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme &ldquo;informations sur les appareils&ldquo;. En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s&apos;y limiter, le nom, le prénom, l&apos;adresse, les informations de paiement, etc.) lors de l&apos;inscription afin de pouvoir exécuter le contrat.</p>
                ...
                <ul>
                    ...
                    <li>Les droits relatifs à la prise de décision automatisée et au profilage.
                        Si vous souhaitez exercer ce droit, veuillez nous contacter via les coordonnées ci-dessous.</li>
                </ul>
                ...
                <p>Lorsque vous remplissez le formulaire de contact présent sur le site, les données inscrite dans le formulaire sont transmise au service <a href="https://getform/io">getform.io</a>, outil me permettant de gérer les demandes de contact. Avec les données présentes dans le formulaire, certaines autre données concernant votre système sont transmises (navigateur web utilisé, adresse IP, ville approximative, ...).
                    Vous pouvez retrouvez les conditions de confidentialité de getform.io via ce lien : <a href="https://getform.io/legal/privacy-policy">https://getform.io/legal/privacy-policy</a></p>
                <h2>Commentaires :</h2>
                <p>Lorsque vous laissez un commentaire sur notre site, un commentaire sur Github est créé dans la catégorie &ldquo;issue&ldquo;, votre pseudonyme, avatar et profile Github sera donc visible et accessible depuis le site.</p>
                <h2>Informations de contact :</h2>
                <p>Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à <a href="mailto:florentvandroy@gmail.com">florentvandroy@gmail.com</a>.</p>
            </div>
        </Layout>
    )
}