  ...
  return (
    ...
    >
      <div className="mt-5">
        ...
        <p>
          Le site web Florent Vandroy est détenu par Florent Vandroy, qui est un
          contrôleur de données de vos données personnelles.
        </p>
        <p>
          Nous avons adopté cette politique de confidentialité, qui détermine la
          manière dont nous traitons les informations collectées par Florent
          Vandroy, qui fournit également les raisons pour lesquelles nous devons
          ...
          d&apos;utiliser le site web de Florent Vandroy.
        </p>
        <p>
        ...
        <p>
          Lorsque vous visitez le Florent Vandroy, nous recueillons
          ...
          terme &ldquo;informations sur les appareils&ldquo;. En outre, nous
          pourrions collecter les données personnelles que vous nous fournissez
          (y compris, mais sans s&apos;y limiter, le nom, le prénom,
        ...
        <p>
          ...
          <Link href="mailto:florentvandroy@gmail.com">
        ...
        <ul>
          ...
          <li>
            ...
            profilage. Si vous souhaitez exercer ce droit, veuillez nous
        ...
        <p>
          Lorsque vous remplissez le formulaire de contact présent sur le site,
          les données inscrite dans le formulaire sont transmise au service{" "}
          <Link href="https://getform/io">getform.io</Link>, outil me permettant
          de gérer les demandes de contact. Avec les données présentes dans le
          formulaire, certaines autre données concernant votre système sont
          transmises (navigateur web utilisé, adresse IP, ville approximative,
          ...). Vous pouvez retrouvez les conditions de confidentialité de
          getform.io via ce lien :{" "}
          <Link href="https://getform.io/legal/privacy-policy">
            https://getform.io/legal/privacy-policy
          </Link>
        </p>
        <h2>Commentaires :</h2>
        <p>
          Lorsque vous laissez un commentaire sur notre site, un commentaire sur
          Github est créé dans la catégorie &ldquo;issue&ldquo;, votre
          pseudonyme, avatar et profile Github sera donc visible et accessible
          depuis le site.
        </p>
